    ...
    <body>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-6">
                    <ul>
                        <li><a href="showingcountrypage">Add Country</a></li>
                        <li><a href="showstatepage">Add State</a></li>
                        <li><a href="showcitypage">Add City</a></li>
                        <li><a href="showareapage">Add Area</a></li>  
