            ...
            <div class="row">
                <div class="col-md-6">
                    <ul>
                        ...
                        <li><a href="showpersonalinfopage">Personal Info</a></li>
                        <li><a href="showemphistorypage">Experience</a></li>
                        <li><a href="showskillpage">Skill</a></li>
                        <li><a href="showjobappliedpage">Job Apply</a></li>
                    </ul>
                </div> 
