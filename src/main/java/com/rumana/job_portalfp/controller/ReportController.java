...
import com.rumana.job_portalfp.daoimple.JasperReportDAO;
import com.rumana.job_portalfp.report.model.JobReport;
...
public class ReportController {
    ...
    public String loadSurveyPg(
            @ModelAttribute("reportInputForm") JobReport reportInputForm, Model model) {
        model.addAttribute("reportInputForm", reportInputForm);
        return "report";
    }
    
    @RequestMapping(value = "/reportView", method = RequestMethod.POST)
    public String generateReport(@ModelAttribute("reportInputForm") JobReport reportInputForm,HttpServletRequest request,HttpServletResponse response) throws JRException, IOException, SQLException, NamingException {
        String reportFileName = "jobreport";
